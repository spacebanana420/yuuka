...
//Help screens
public class help {
    static String title() {return "Yuuka version 1.4.1";}
    ...
    return
      ...
      + "\nExample: yuuka build --release"
      + "\nFor passing arguments to program execution (used in run/test): e.g. yuuka test [options] <test class> -- [arguments]"
      + "\n\nAvailable commands:"
