...
public class stdout {
  public static void print(String message) {
    if (options.PRINT_LEVEL > 0) {System.out.println(message);}
  }

  public static void print(String title, String[] contents) {
    if (options.PRINT_LEVEL > 0) {printSeq(title, contents);}
  }

  public static void print_verbose(String message) {
    if (options.PRINT_LEVEL > 1) {System.out.println(message);}
  }

  public static void print_verbose(String title, String[] contents) {
    if (options.PRINT_LEVEL > 1) {printSeq(title, contents);}
  }

  public static void print_debug(String message) {
    if (options.PRINT_LEVEL > 2) {System.out.println(message);}
  }

  public static void print_debug(String title, String[] contents) {
    if (options.PRINT_LEVEL > 2) {printSeq(title, contents);}
  }
  ...
  public static void error(String message) {
    if (options.PRINT_LEVEL > 0) {System.err.println(message);}
  }
